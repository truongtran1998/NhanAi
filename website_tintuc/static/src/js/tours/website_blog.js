odoo.define("website_tintuc.tour", function (require) {
    "use strict";
    ...
    tour.register("tintuc", {
        ...
        trigger: "a[data-action=new_tintuc_post]",
        content: _t("Select this menu item to create a new tintuc post."),
        position: "bottom",
    }, {
        trigger: "button.btn-continue",
        extra_trigger: "form[id=\"editor_new_tintuc\"]",
        content: _t("Select the tintuc you want to add the post to."),
        ...
        trigger: "div[data-oe-expression=\"tintuc_post.name\"]",
        ...
        extra_trigger: "#wrap div[data-oe-expression=\"tintuc_post.name\"]:not(:containsExact(\"\"))",
        content: Markup(_t("Set a tintuc post <b>cover</b>.")),
        position: "top",
    }, {
        ...
        content: Markup(_t("<b>Write your story here.</b> Use the top toolbar to style your text: add an image or table, set bold or italic, etc. Drag and drop building blocks for more graphical tintucs.")),
        position: "top",
        run: function (actions) {
            actions.auto();
            actions.text("Tin tuc content", this.$anchor.find("p"));
        },
    }, {
        ...
        content: Markup(_t("Use this icon to preview your tintuc post on <b>mobile devices</b>.")),
        position: "bottom",
    }, {
        ...
        extra_trigger: "body:not(.editor_enable)",
        position: "bottom",
        content: Markup(_t("<b>Publish your tintuc post</b> to make it visible to your visitors.")),
    }, {
        trigger: "#customize-menu > a",
        extra_trigger: ".js_publish_management .js_publish_btn .css_unpublish:visible",
        content: Markup(_t("<b>That's it, your tintuc post is published!</b> Discover more features through the <i>Customize</i> menu.")),
        position: "bottom",
        width: 500,
    }]);
});
